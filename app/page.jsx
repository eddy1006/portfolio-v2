    ...
    <div className="flex-grow grid place-items-center">
      ...
      <div className="flex gap-3">
        <a href="https://github.com/eddy1006" target="_blank">
          <div className="bg-githubColor  opacity-30 h-12 w-12 hover:opacity-100"></div>
        </a>
        <a
          href="https://www.linkedin.com/in/aditya-gupta-0985b621a/"
          target="_blank"
        >
          <div className="bg-linkedinColor opacity-30 h-12 w-12 hover:opacity-100"></div>
        </a>
        <a href="https://twitter.com/eddityyaa" target="_blank">
          <div className="bg-xColor opacity-30 h-12 w-12 hover:opacity-100"></div>
        </a>
        <a href="https://leetcode.com/adigupta239/" target="_blank">
          <div className="bg-leetcodeColor opacity-30 h-12 w-12 hover:opacity-100"></div>
        </a>
      </div>
    </div>
  );
